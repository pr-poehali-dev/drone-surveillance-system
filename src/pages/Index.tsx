      ...
      >
        ...
        <section className="flex min-h-screen w-screen shrink-0 flex-col justify-end overflow-y-auto px-6 pb-16 pt-24 md:px-12 md:pb-24" style={{ scrollbarWidth: "none" }}>
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6 animate-in fade-in slide-in-from-bottom-8 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground duration-1000 md:text-4xl lg:text-5xl">
            ...
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                Методические материалы, курсы повышения квалификации и сообщество единомышленников для тех, кто учит и вдохновляет.
              </span>
            </p>
