          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                будущее
                <br />
                <span className="text-foreground/40">образования</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Мы — команда методистов и практикующих педагогов, которые помогают учителям расти профессионально.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Собираем лучшие материалы, проводим обучение и создаём пространство для обмена опытом между коллегами.
              </p>
            </div>
          </div>
